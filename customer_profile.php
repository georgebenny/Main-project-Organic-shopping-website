...
<body> 
	...
	<div class="container">
			...
			?>
			<div class="card">
  <img src="images/profile/customer_profile.jpg" alt="John" style="width:50%">
  ...
  <p><?php echo $_SESSION['alogin']; ?></p>
							...
							function checkFName()
									{
										...
										if(document.getElementById('firstname').value==null || update.firstname.value.length==0)
										{
			...
			<input type="text" name="phonem" id="phonem" placeholder="Phone number"  value="<?php echo $ph;?>" class="input input1 form-control"onblur="checkMob()"required>
