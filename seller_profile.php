...
<body> 
	...
	<div class="container">
      	   ...
      	   <div class="account_grid">
			   <div class=" login-right">
			  	<marquee behavior="" direction="right"><h3>Welcome  to organic world</h3></marquee>
			<?php 	
			$con=mysqli_connect("localhost","root","","organic_shop_db")or die ("Couldn't connect");
			...
			?>
			<div class="card">
  <img src="images/profile/seller_profile.jpg" alt="John" style="width:50%">
  ...
  <p><?php echo $_SESSION['alogin']; ?></p>
			   ...
			   <form onsubmit="return validateForm()" action="" method="POST" id="update" name="update" > 
			...
			<input type="text" name="phonem" id="phonem" placeholder="Phone number"class="input input1 form-control"   value="<?php echo @$ph;?>" onblur="checkMob()"required>
