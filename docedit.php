<?php
$con= mysqli_connect("localhost","root","","organic_shop_db");
$product_category_id=$_POST["edit"];
session_start();
				...
				<div class="card-body">
                                      ...
                                      <form action="docedit1.php" method="post" novalidate="novalidate">
                                          <div class="form-group">
											<?php
											$sql = "SELECT * FROM `tbl_product_category` WHERE product_category_id = '$product_category_id'";
                                            ...
                                            <input id="docid" name="product_category_id" type="hidden" class="form-control" value="<?php echo $product_category_id; ?>" aria-required="true" aria-invalid="false" >
                                              ...
                                              <input id="docname" name="prod_category_name" type="text" class="form-control" required value="<?php echo $row['prod_category_name']; ?>">
                                              <p id="d1"></p>
                                              <script>
