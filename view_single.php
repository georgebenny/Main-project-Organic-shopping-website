						...
						<ul id="etalage">
							<li>
								<a href="optionallink.html">
									<img class="etalage_thumb_image" src="images/<?php echo $rowp['image'] ?>"  class="img-responsive watch-right" alt="image"/>
									<img class="etalage_source_image" src="images/<?php echo $rowp['image'] ?>" class="img-responsive" title="" />
								</a>
							</li>
