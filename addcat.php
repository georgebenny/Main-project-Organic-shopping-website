...
while($row=mysqli_fetch_array($disp_presult))
                                          {
                                            ...
                                            <tr>
												...
												<td><button type="submit" name="edit" value="<?php echo $row['product_category_id']?>"><img src="images/edit.png" width="25" height="25"></button></td>
												</form>
												<form action="dodelete.php" method="POST">
												<td><button type="submit" name="delete" value="<?php echo $row['product_category_id']?>"><img src="images/delete.png" width="25" height="25"></button></td>
												</form>
											</tr>
